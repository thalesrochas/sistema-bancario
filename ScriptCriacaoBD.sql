...
CREATE TABLE IF NOT EXISTS `conta_poupanca` (
  ...
  PRIMARY KEY (`num_conta`),
  CONSTRAINT `fk_Poupança_Contas1`
...
CREATE TABLE IF NOT EXISTS `conta_especial` (
  ...
  PRIMARY KEY (`num_conta`),
  CONSTRAINT `fk_Conta especial_Contas1`
    FOREIGN KEY (`num_conta`)
    REFERENCES `conta` (`num_conta`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `realiza` (
  ...
  CONSTRAINT `fk_Transacoes_has_Contas_Transacoes1`
    FOREIGN KEY (`num_transacao`)
    REFERENCES `transacao` (`num_transacao`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Transacoes_has_Contas_Contas1`
    FOREIGN KEY (`num_conta`)
    REFERENCES `conta` (`num_conta`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `conta_cliente` (
  ...
  CONSTRAINT `fk_Cliente-Conta_Clientes1`
    FOREIGN KEY (`cpf_cliente`)
    REFERENCES `cliente` (`cpf`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cliente-Conta_Contas1`
    FOREIGN KEY (`num_conta`)
    REFERENCES `conta` (`num_conta`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cliente-Conta_agencia1`
    FOREIGN KEY (`num_agencia`)
    REFERENCES `agencia` (`numero`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `dependente` (
  ...
  `parentesco` ENUM('Filho', 'Filha', 'Cônjuge', 'Genitor', 'Genitora') NOT NULL,
  `data_nasc` DATE NOT NULL,
  `idade` INT NULL,
...
-- -----------------------------------------------------
-- View `conta_do_cliente`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `conta_do_cliente` ;
USE `Equipe374876`;
CREATE  OR REPLACE VIEW `conta_do_cliente` AS
    SELECT 
        cli.cpf, cli.nome, cli.cidade, cc.num_conta
    FROM
        cliente cli
            JOIN
        conta_cliente cc ON cli.cpf = cc.cpf_cliente;

-- -----------------------------------------------------
-- View `transacao_do_cliente`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `transacao_do_cliente` ;
USE `Equipe374876`;
CREATE  OR REPLACE VIEW `transacao_do_cliente` AS
    SELECT 
        r.num_conta, t.*
    FROM
        realiza r
            JOIN
        transacao t ON r.num_transacao = t.num_transacao;
...
START TRANSACTION;
USE `Equipe374876`;
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (1, 2430.89, '2016-03-25 02:33:36', 'Estorno');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (2, -944.64, '2016-05-18 21:11:11', 'Saque');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (3, -2978.10, '2016-07-18 11:30:25', 'Transferência');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (4, 2978.10, '2016-07-18 11:30:25', 'Transferência');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (5, 1536.86, '2016-12-17 05:36:54', 'Depósito');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (6, -4182.24, '2017-01-15 23:15:54', 'Saque');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (7, 4044.63, '2017-01-23 14:21:30', 'Depósito');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (8, -1509.83, '2017-01-25 02:23:52', 'Saque');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (9, -331.63, '2017-02-10 13:10:10', 'Transferência');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (10, 331.63, '2017-02-10 13:10:10', 'Transferência');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (11, 1118.84, '2017-02-23 16:42:34', 'Estorno');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (12, 3623.83, '2017-03-03 12:20:45', 'Depósito');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (13, -2802.90, '2017-04-04 10:50:29', 'Transferência');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (14, 2802.90, '2017-04-04 10:50:29', 'Transferência');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (15, -333.92, '2017-04-24 16:30:00', 'Transferência');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (16, 333.92, '2017-04-24 16:30:00', 'Transferência');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (17, -2383.09, '2017-04-29 13:02:52', 'Saque');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (18, 432.42, '2017-05-23 15:50:41', 'Depósito');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (19, -1682.85, '2017-06-30 10:12:20', 'Saque');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (20, 3495.94, '2017-07-28 05:21:16', 'Estorno');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (21, 1522.92, '2017-08-17 12:50:51', 'Estorno');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (22, -4003.64, '2017-09-02 09:28:27', 'Transferência');
INSERT INTO `transacao` (`num_transacao`, `valor_transacao`, `data_hora`, `tipo`) VALUES (23, 4003.64, '2017-09-02 09:28:27', 'Transferência');
...
START TRANSACTION;
USE `Equipe374876`;
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('41587462518', '541284628-186484', 'Dustin Henderson', '1971-04-18', 'Hawkings', 'Rua José Parente Sampaio');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('88544517866', '522492566-562452', 'Will Byers', '1971-08-28', 'Hawkings', 'Rua B');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('59944568461', '795121463-284186', 'Mike Wheeler', '1971-12-01', 'Hawkings', 'Rua Murici');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('58549135133', '784931658-194716', 'Frida Kahlo', '1945-11-03', 'Icó', 'Rua Menezes Paredes');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('19416568746', '116511188-516659', 'Margaret Hamilton', '1922-05-05', 'Indiana', 'Rua Foz do Iguaçu');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('84154951621', '162195165-156744', 'Brenda Chapman', '1959-08-26', 'Beason', 'Rua Carlos Marighela');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('47948651514', '847151635-845145', 'Irena Sendler', '1960-04-04', 'Londres', 'Rua Arabidé');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('84984561515', '988787845-545447', 'Nelson Mandela', '1959-08-25', 'Icó', 'Rua F');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('79488487552', '788484841-112224', 'Kelgilson Gomes', '1976-01-01', 'Icó', 'Rua Augusto Cesar');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('98963112021', '022132315-212121', 'Fred Mercury', '1965-02-23', 'Sobral', 'Rua da Arabaiana');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('84484848484', '878451512-021661', 'Alan Turing', '1943-07-18', 'Indiana', 'Rua Tancredo Neves');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('56691223322', '987426124-517516', 'Gretchen Queen', '1996-09-21', 'Sobral', 'Rua Tancredo Neves');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('15975764216', '324164251-572726', 'Xuxa Meneguel', '1923-10-31', 'Meruoca', 'Rua José de Alencar');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('71279279197', '622167515-979159', 'Margareth Thacher', '1930-11-04', 'Londres', 'Rua Arabidé');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('79497859457', '878795151-845153', 'Machado de Assis', '1919-05-05', 'Beason', 'Rua José Parente Sampaio');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('76151230215', '034261597-177597', 'Clark Kent', '1987-12-26', 'Sobral', 'Rua F');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('84415154845', '474164879-997499', 'Evaristo Costa', '1978-06-13', 'Meruoca', 'Rua Menezes Paredes');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('72975957917', '127915974-979459', 'Anne Hathway', '1987-03-28', 'Pereiro', 'Rua B');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('97548749742', '416164126-597794', 'Theodoro Bertotti', '1963-05-08', 'Ouro Preto', 'Rua Murici');
INSERT INTO `cliente` (`cpf`, `rg`, `nome`, `data_nasc`, `cidade`, `endereco`) VALUES ('32623126547', '619761674-527777', 'Beyonce  Knowles', '1959-08-25', 'Gramado', 'Rua Augusto Cesar');
...
INSERT INTO `dependente` (`mat_funcionario`, `nome_dependente`, `parentesco`, `data_nasc`, `idade`) VALUES (10, 'Sophia Moura', 'Filha', '1992-11-18', 24);
INSERT INTO `dependente` (`mat_funcionario`, `nome_dependente`, `parentesco`, `data_nasc`, `idade`) VALUES (10, 'Elisa Moura', 'Genitora', '1953-08-22', 64);
...
INSERT INTO `dependente` (`mat_funcionario`, `nome_dependente`, `parentesco`, `data_nasc`, `idade`) VALUES (8, 'Sophie Campos', 'Filha', '1999-04-24', 18);
...
INSERT INTO `dependente` (`mat_funcionario`, `nome_dependente`, `parentesco`, `data_nasc`, `idade`) VALUES (10, 'Júlia Schiavon', 'Filha', '1995-10-21', 22);
...
INSERT INTO `dependente` (`mat_funcionario`, `nome_dependente`, `parentesco`, `data_nasc`, `idade`) VALUES (6, 'Britanney Michael', 'Genitora', '1938-10-23', 79);
...
INSERT INTO `dependente` (`mat_funcionario`, `nome_dependente`, `parentesco`, `data_nasc`, `idade`) VALUES (7, 'Lawrence Jackson', 'Filha', '2017-11-07', 0);
INSERT INTO `dependente` (`mat_funcionario`, `nome_dependente`, `parentesco`, `data_nasc`, `idade`) VALUES (6, 'Olga Houston', 'Filha', '1991-06-22', 26);
INSERT INTO `dependente` (`mat_funcionario`, `nome_dependente`, `parentesco`, `data_nasc`, `idade`) VALUES (15, 'Imogene Parks', 'Genitora', '1956-08-29', 61);
INSERT INTO `dependente` (`mat_funcionario`, `nome_dependente`, `parentesco`, `data_nasc`, `idade`) VALUES (6, 'Olivia Collins', 'Filha', '1987-06-29', 30);
INSERT INTO `dependente` (`mat_funcionario`, `nome_dependente`, `parentesco`, `data_nasc`, `idade`) VALUES (1, 'Kaye Delaney', 'Filha', '1997-03-03', 20);
INSERT INTO `dependente` (`mat_funcionario`, `nome_dependente`, `parentesco`, `data_nasc`, `idade`) VALUES (9, 'Tasha Aguilar', 'Filha', '2017-10-29', 0);
...
BEGIN
	IF ((SELECT valor_transacao FROM transacao t WHERE t.num_transacao = NEW.num_transacao) < -(SELECT saldo FROM conta c WHERE c.num_conta = NEW.num_conta))
		AND (((SELECT tipo_conta FROM conta c WHERE c.num_conta = NEW.num_conta) = 'Conta Corrente')
        OR ((SELECT tipo_conta FROM conta c WHERE c.num_conta = NEW.num_conta) = 'Conta Poupança')) THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Saldo Insuficiente!';
	
    ELSEIF (SELECT valor_transacao FROM transacao t WHERE t.num_transacao = NEW.num_transacao) <
		-((SELECT saldo FROM conta c WHERE c.num_conta = NEW.num_conta) + (SELECT limite_credito FROM conta_especial ce WHERE ce.num_conta = NEW.num_conta)) THEN
